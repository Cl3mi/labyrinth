...
public class GameService {
    ...
    public GameService(TreasureCardFactory treasureCardFactory,
        ...
        var aiStrategy = new labyrinth.server.game.ai.SimpleAiStrategy();
        game = new Game(turnTimer, durationTimer, applicationEventPublisher, aiStrategy, gameLogger);
    }
    ...
    public void startGame(GameConfig gameConfig) {
        ...
        try {
            ...
            // Pass treasureCards to game.startGame instead of treasureCardFactory
